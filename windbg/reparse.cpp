 ...
 */
int  INTERNAL RECharType (char *p)
{
         if (fZSyntax)
        /*  Zibo syntax
         */
 ...
 *  returns     length in chars of type
 */
int  INTERNAL REClosureLen (char *p)
{
         return 1;
}
 ...
 *              NULL otherwise (syntax error)
 */
char *  INTERNAL REParseAny (PACT pAction, char *p)
{
 ...
 *              NULL otherwise (syntax error)
 */
char *  INTERNAL REParseBOL (PACT pAction, char *p)
{
 ...
 *              NULL otherwise (syntax error)
 */
char *  INTERNAL REParseClosure (PACT pAction, register char *p)
{
         UINT_PTR u;
 ...
 */
char   INTERNAL REClosureChar (char *p)
{
