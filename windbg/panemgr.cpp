...
LRESULT FAR CALLBACK LOADDS PaneButtonWndProc(HWND,UINT,WPARAM,LPARAM);
LRESULT FAR CALLBACK LOADDS PaneLeftWndProc(HWND,UINT,WPARAM,LPARAM);
LRESULT FAR CALLBACK LOADDS PaneRightWndProc(HWND,UINT,WPARAM,LPARAM);
LRESULT FAR CALLBACK LOADDS PaneSizerWndProc(HWND,UINT,WPARAM,LPARAM);
...
**
**  Synopsis:
**      LRESULT  PaneLeftWndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
**
**  Entry:
**      Standard WNDPROC
**
...
**
**  Synopsis:
**      LRESULT  PaneRightWndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
**
**  Entry:
**      Standard WNDPROC
**
