...
void  InsertEditLine(int doc, LPSTR EditText, int y, BOOL VisualUpdate)
{
    int EditLen;
...
void  DeleteEditLine(int doc, int y, BOOL VisualUpdate)
{
...
void  AddEditLine(int doc, LPSTR EditText, BOOL VisualUpdate)
{
...
void  ReplaceEditLine(int doc, LPSTR EditText, int y, BOOL VisualUpdate)
{
...
void  SetDocLines(int doc, int lines)
{
    int i;
    int curLines;
