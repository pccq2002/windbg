...
int WINAPI WinMain(
				   ...
				   LPSTR    lpCmdLine1,        //指向以\0结尾的命令行，不包括EXE本身的文件名，
            ...
            case IDM_FILE_OPEN_EXECUTABLE:
                {
                    ...
                    if (StartFileDlg(
                        ...
                        szExeName,                             // Path/file
                        &dw,                            // Flags
                        (LPOFNHOOKPROC)OpenExeWithArgsHookProc)) {
            ...
            case IDM_FILE_OPEN:
                {
                    ...
                    if (IDM_FILE_OPEN == wItemId) {
                        ...
                        if (!StartFileDlg(hwnd, DLG_Open_Filebox_Title, DEF_Ext_SOURCE,
                            IDM_FILE_OPEN, 0, (LPSTR) szPath, &dwFlags, (LPOFNHOOKPROC)DlgFile)) {
...
// BUGBUG - dead code - kcarlos
            ...
            case IDM_EDIT_FIND:
                ...
                if (frMem.hDlgFindNextWnd) {
                    ...
                    if (StartDialog(DLG_FIND, (DLGPROC)DlgFind)) {
                        Find();
                    }
                }
                break;
            ...
            case IDM_EDIT_REPLACE:
                ...
                if (frMem.hDlgConfirmWnd) {
                    ...
                    if (StartDialog(DLG_REPLACE, (DLGPROC)DlgReplace)) {
            ...
            case IDM_EDIT_PROPERTIES:
                {
                    ...
                    if (!(nCurDoc < -1)) {
                        if (MEMORY_WIN == Docs[nCurDoc].docType) {
                            ...
                            StartDialog(DLG_MEMORY, (DLGPROC)DlgMemory);
                        } else {
                            Dbg(0);
                        }
                    } else {
                        ...
                        case WATCH_WIN:
                            ...
                            StartDialog( DLG_PANEOPTIONS, (DLGPROC)DlgPaneOptions);
                            break;
            ...
            case IDM_EDIT_GOTO_LINE:
                StartDialog(DLG_LINE, (DLGPROC)DlgLine);
                break;

            case IDM_EDIT_GOTO_ADDRESS:
                StartDialog(DLG_FUNCTION, (DLGPROC)DlgFunction);
                break;
            ...
            case IDM_DEBUG_ATTACH:
                if (OsVersionInfo.dwPlatformId == VER_PLATFORM_WIN32_NT) {
                    StartDialog(DLG_TASKLIST, (DLGPROC)DlgTaskList);
                }
                break;
            ...
            case IDM_DEBUG_EXCEPTIONS:
                StartDialog(DLG_DEBUGEXCP, (DLGPROC)DlgDbugexcept);
                break;
            ...
            case IDM_EDIT_BREAKPOINTS:
                ...
                if ( g_contWorkspace_WkSp.m_bKernelDebugger && IsProcRunning(LppdCur) ) {
                    ...
                    StartDialog(DLG_BREAKPOINTS, (DLGPROC)DlgSetBreak);
                }
                break;

            case IDM_DEBUG_QUICKWATCH:
                StartDialog(DLG_QUICKWATCH, (DLGPROC)DlgQuickW);
                break;

            case IDM_DEBUG_SET_THREAD:
                StartDialog(DLG_THREAD, (DLGPROC)DlgThread);
                break;

            case IDM_DEBUG_SET_PROCESS:
                StartDialog(DLG_PROCESS, (DLGPROC)DlgProcess);
                break;
