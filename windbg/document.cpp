...
void NEAR  ReadOnlyBeep (void);
LPBLOCKDEF NEAR  FreeBlock (int doc, LPBLOCKDEF pCurBlock);
void NEAR  ModifiedDoc (int doc);
BOOL NEAR  FindInsertSpace (int doc, LPBLOCKDEF *pCurBlock, LPLINEREC *pCurLine, LPSTR pBlockEnd, int sizeExpansion);
BOOL NEAR  CancelDelete (int doc);
BOOL NEAR  PartialLineDelete (int doc, LPBLOCKDEF *pCurBlock, LPLINEREC *pCurLine, int *totalSize, int col1, int col2, BOOL moveToNextLine);
BOOL NEAR  FullLineDelete (int doc, LPBLOCKDEF *pCurBlock, LPLINEREC *pCurLine, int *totalSize);
BOOL NEAR  JoinLines (int doc, LPBLOCKDEF pCurBlock, LPLINEREC pCurLine, int *totalSize, int lineNb, int col1);
