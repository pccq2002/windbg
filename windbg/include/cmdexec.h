...
extern BOOL WINAPI CmdExecuteLine(LPSTR);
...
VOID   WINAPI CmdSetCmdProc(
        BOOL (WINAPI*lpfnLP)(LPSTR lpsz),
        VOID (WINAPI*lpfnPP)(BOOL, BOOL) );

LOG_DM LetterToType( char c );
BOOL WINAPI  CmdExecuteLine(LPSTR);
VOID WINAPI  CmdExecutePrompt(BOOL,BOOL);
BOOL WINAPI  CmdEnterLine(LPSTR);
VOID WINAPI  CmdEnterPrompt(BOOL,BOOL);
BOOL WINAPI  CmdAsmLine(LPSTR);
VOID WINAPI  CmdAsmPrompt(BOOL,BOOL);
