...
int   INTERNAL RECharType (char *);
int   INTERNAL RECharLen (char *);
int   INTERNAL REClosureLen (char *);
char *    INTERNAL REParseRE (PACT, char *,int *);
char *    INTERNAL REParseE (PACT,char *);
char *    INTERNAL REParseSE (PACT,char *);
char *    INTERNAL REParseClass (PACT,char *);
char *    INTERNAL REParseAny (PACT,char *);
char *    INTERNAL REParseBOL (PACT,char *);
char *    INTERNAL REParsePrev (PACT, char *);
char *    INTERNAL REParseEOL (PACT,char *);
char *    INTERNAL REParseAlt (PACT,char *);
char *    INTERNAL REParseNot (PACT,char *);
char *    INTERNAL REParseAbbrev (PACT,char *);
char *    INTERNAL REParseChar (PACT,char *);
char *    INTERNAL REParseClosure (PACT,char *);
char *    INTERNAL REParseGreedy (PACT,char *);
char *    INTERNAL REParsePower (PACT,char *);
char      INTERNAL REClosureChar (char *);
char      INTERNAL Escaped (char );

void      INTERNAL REStackOverflow (void);
void      INTERNAL REEstimate (char *);
