...
PTRVIB  PvibAlloc(PTRVIB, PTRVIB);
VOID    FTAgeVibValues(PTRVIB);
void    FTclnUpdateParent( PTRVIB pvibParent, int dcln );
PTRVIB  FTvibGetAtLine( PTRVIT pvit, ULONG oln );
VOID    FTEnsureTextExists( PTRVIB pVib );
LTS     FTExpand ( PTRVIT  pvit, ULONG oln );
VOID    FTExpandOne( PTRVIB pVib);
VOID    FTFreeAllSib( PTRVIB pvib );
BOOL    FTVerify(PCXF pcxf, PTRVIB pvib);
int     FTMakeWatchEntry(void *, void *, char *);
LTS     FTError(LTS);
PSTR    FTGetVibNames(PTRVIT, BOOL, PLONG);
PSTR    FTGetWatchList(PTRVIT);
PSTR    FTGetVibResults(PTRVIT, BOOL, PLONG);
PSTR    FTGetVibNameString(PTRVIB pVib);
PSTR    FTGetVibResultString(PTRVIT pVit, PTRVIB pVib);
PSTR    FTGetVibTypeString(PTRVIB pVib);
BOOL    FTGetPanelStatus( PTRVIB pVib, UINT PanelNumber);
PSTR    FTGetPanelString( PTRVIT pVit, PTRVIB pVib, UINT PanelNumber);
VOID    FTSetWatchList(PTRVIT, PSTR);
PTRVIB  FTvibGet ( PTRVIB, PTRVIB );
PTRVIB  FTvibInit( PTRVIB, PTRVIB );
PTRVIB  FTvibGetAtLine( PTRVIT pvit, ULONG oln );
BOOL    FTVerifyNew( PTRVIT pvit, ULONG oln);
