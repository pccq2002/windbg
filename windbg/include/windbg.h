...
#define MAX_USER_LINE       0x10 + (MAX_LINE_SIZE - LHD - 1) //Max length of user line
...
typedef struct {
    ...
    WORD            language;               // C,  or no language document
    BOOL            untitled;
    BOOL            ismodified;
...
long  CALLBACK DlgSetBreak(HWND, UINT, WPARAM, LPARAM);
