...
void  EnsureScrollBars(int view, BOOL force)
{
...
****************************************************************************/
void  EscapeAmpersands(LPSTR AmpStr, int MaxLen)
{
        char szBuffer[255];
        int i = 0, j = 0;
...
****************************************************************************/
void  UnescapeAmpersands(LPSTR AmpStr, int MaxLen)
{
        char szBuffer[255];
        int i = 0, j = 0;
