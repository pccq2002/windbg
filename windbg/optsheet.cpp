...
int NEAR  ChangeTabs(int doc, int newTabSize);
...
//            BOOL bEnabled;
            ...
            case IDC_BUT_SEARCH_ORDER:
                if (BN_CLICKED == wNotifyCode) {
                    StartDialog(IDD_DLG_SRC_SEARCH_PATH, (DLGPROC)DlgProc_SrcSearchPath);
                    return TRUE;
                }
                break;
            }
