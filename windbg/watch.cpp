...
void NEAR  WatchDefPushButton(HWND hDlg, int Id)
{
...
void  NEAR FillWatchListbox(HWND hDlg)
{
...
void  NEAR AddWatchListbox(HWND hDlg, PSTR szExpress)
{
    PTRVIB pVib;
...
void  NEAR DeleteWatchListbox(HWND hDlg, int WatchNum)
{
    PTRVIT pVit = GetWatchVit();
...
void  NEAR ClearAllWatch(HWND hDlg)
{
    PTRVIT pVit = GetWatchVit();
    PTRVIB pVib = pVit->pvibChild;
