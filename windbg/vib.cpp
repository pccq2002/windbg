...
PTRCIF  FTGetCif( VOID );
VOID    FTFreeVib( PTRVIB );
VOID    FTFreeVibChildren( PTRVIB );
VOID    FTFreeAllCif( PTRCIF );
LTS     FTExpandVib( PTRVIB pvib );
VOID    FTInvalidateVib( PTRVIB pvib);
VOID    FTResetVib( PTRVIB pvib);
BOOL    FTSetupWoj( PTRVIB pvib, PSTR pName, UINT cbSize);
