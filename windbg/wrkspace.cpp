...
{
    INT_PTR nRes = StartDialog( DLG_WINDOW_LAYOUT_SAVEAS, (DLGPROC)DlgProc_WindowLayout_SaveAs );
...
{
    INT_PTR nRes = StartDialog( IDD_DLG_MNG_WINLAYOUT, (DLGPROC)DlgProc_WindowLayout_Manage );
...
SaveAs_WkSp_Prompt()
{
    INT_PTR nRes = StartDialog( DLG_WRKSPC_SAVEAS, (DLGPROC)DlgProc_WorkSpace_SaveAs );
...
Manage_WkSp_Prompt()
{
    INT_PTR nRes = StartDialog(IDD_DLG_MNG_WRKSPC, (DLGPROC)DlgProc_WorkSpace_Manage);
