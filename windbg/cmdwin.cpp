    ...
    // BUGBUG -- jls Need to put in new code to deal with this problem.
            ...
            case dbcBpt:               /* DBG_REFRESH */
                ...
                if ( FKilling || !DebuggeeActive() ) {
                    ...
                    bpstatus = BPCheckHbpt( CxfIp, (LPFNBPCALLBACK)BPCallbackHbpt,
...
{
    fCtrlCPressed = FALSE;
    pPolledCtrlCHandler = AddCtrlCHandler((CTRLC_HANDLER_PROC)PolledCtrlCHandler, FALSE);
}
...
--*/
{
    ...
    case WU_INITDEBUGWIN:
         ...
         */
        AddCtrlCHandler((CTRLC_HANDLER_PROC)DoCtrlCAsyncStop, FALSE);
    ...
    case WM_DESTROY:
        ...
        */
        ...
        FreeProcInstance((WNDPROC)SetWindowLongPtr(hwnd, GWLP_WNDPROC,
                                                 (DWORD)lpfnEditProc));
// 		FreeProcInstance((WNDPROC)SetWindowLongW(hwnd, GWLP_WNDPROC,
//                                                  (DWORD)lpfnEditProc));
