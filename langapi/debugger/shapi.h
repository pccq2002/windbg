...
typedef SHFLAG  (FAR  *PFNCMP) (HVOID, HVOID, LSZ, SHFLAG);
typedef SHE     (FAR  *PFNVALIDATEEXE) (HANDLE, PVLDCHK);
typedef BOOL    (FAR  *PFNVALIDATEDEBUGINFOFILE) (LPCSTR szFile, ULONG * errcode );
