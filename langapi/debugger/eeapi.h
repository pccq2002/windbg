...
typedef struct {
    void     ( *pEEFreeStr)(EEHSTR);
    EESTATUS ( *pEEGetError)(PHTM, EESTATUS, PEEHSTR);
    EESTATUS ( *pEEParse)(const char *, EERADIX, SHFLAG, PHTM, ulong  *);
    EESTATUS ( *pEEBindTM)(PHTM, PCXT, SHFLAG, SHFLAG);
    EESTATUS ( *pEEvaluateTM)(PHTM, HFRAME, EEDSP);
    EESTATUS ( *pEEGetExprFromTM)(PHTM, PEERADIX, PEEHSTR, DWORD *);
    EESTATUS ( *pEEGetValueFromTM)(PHTM, EERADIX, PEEFORMAT, PEEHSTR);
    EESTATUS ( *pEEGetNameFromTM)(PHTM, PEEHSTR);
    EESTATUS ( *pEEGetTypeFromTM)(PHTM, EEHSTR, PEEHSTR, ulong);
    EESTATUS ( *pEEFormatCXTFromPCXT)(PCXT, PEEHSTR, DWORD);
    void     ( *pEEFreeTM)(PHTM);
    EESTATUS ( *pEEParseBP)(char *, EERADIX, SHFLAG, PCXF, PTML, ulong, DWORD *, SHFLAG);
    void     ( *pEEFreeTML)(PTML);
    EESTATUS ( *pEEInfoFromTM)(PHTM, PRI, PHTI);
    void     ( *pEEFreeTI)(PHTI);
    EESTATUS ( *pEEGetCXTLFromTM)(PHTM, PHCXTL);
    void     ( *pEEFreeCXTL)(PHCXTL);
    EESTATUS ( *pEEAssignTMToTM)(PHTM, PHTM);
    EEPDTYP  ( *pEEIsExpandable)(PHTM);
    SHFLAG   ( *pEEAreTypesEqual)(PHTM, PHTM);
    EESTATUS ( *pEEcChildrenTM)(PHTM, long *, PSHFLAG);
    EESTATUS ( *pEEGetChildTM)(PHTM, long, PHTM, DWORD *, EERADIX, SHFLAG);
    EESTATUS ( *pEEDereferenceTM)(PHTM, PHTM, DWORD *, SHFLAG);
    EESTATUS ( *pEEcParamTM)(PHTM, DWORD *, PSHFLAG);
    EESTATUS ( *pEEGetParmTM)(PHTM, DWORD, PHTM, DWORD *, SHFLAG);
    EESTATUS ( *pEEGetTMFromHSYM)(HSYM, PCXT, PHTM, DWORD *, SHFLAG, SHFLAG);
    EESTATUS ( *pEEFormatAddress)(PADDR, char *, DWORD, SHFLAG);
    EESTATUS ( *pEEGetHSYMList)(PHSYML, PCXT, DWORD, uchar *, SHFLAG);
    void     ( *pEEFreeHSYMList)(PHSYML);
    EESTATUS ( *pEEGetExtendedTypeInfo)(PHTM, PETI);
    EESTATUS ( *pEEGetAccessFromTM)(PHTM, PEEHSTR, ulong);
    BOOL     ( *pEEEnableAutoClassCast)(BOOL);
    void     ( *pEEInvalidateCache)(void);
    EESTATUS ( *pEEcSynthChildTM)(PHTM, long *);
    EESTATUS ( *pEEGetBCIA)(PHTM, PHBCIA);
    void     ( *pEEFreeBCIA)(PHBCIA);
    SHFLAG   ( *pfnCmp)(HVOID, HVOID, char *, SHFLAG);
    SHFLAG   ( *ptdCmp)(HVOID, HVOID, char *, SHFLAG);
    SHFLAG   ( *pcsCmp)(HVOID, HVOID, char *, SHFLAG);
    MPT      ( *pEESetTarget)(MPT);
    void     ( *pEEUnload)();
} EXF;
typedef EXF * PEXF;
