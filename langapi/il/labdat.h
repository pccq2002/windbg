...
LABDAT(NA_FORDOWN,			".FD%d_%s")		/*  FOR DOWNTO .. */
LABDAT(NA_FORUP,			".FU%d_%s")		/*  FOR .. TO .. */
LABDAT(NA_FBREAK,			".FB%d_%s")
LABDAT(NA_FCONTINUE,		".FC%d_%s")
LABDAT(NA_FCYCLE,			".FC%d_%s")

LABDAT(NA_REPEAT,			".R%d_%s")		/*  REPEAT. */
