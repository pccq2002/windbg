...
CDAT(   ESC,        000000|000000,      2,      1,      RNON,                   "esc",      ACLS_ESC,   ASM_M0, "\330",                 XX,     P_86 )
...
CDAT(   IN,         000000|000000,      1,      1,      RNON,                   "in",       ACLS_IO,    ASM_M0, "\344\354\345\355",     XX,     P_86 )
CDAT(   OUT,        000000|000000,      1,      1,      RNON,                   "out",      ACLS_IO,    ASM_M1, "\346\356\347\357",     XX,     P_86 )
...
QDAT(   FSTTP,      DFLT|00000000,      1,      2,      R111,                   "_fsttp ",  ACLS_FIMMW, ASM_M3, "\3",                   XX,     P_86 ) /* fstp st(0) */
...
QDAT(   IMUL3,      DSETCC,             2,      1,      RNON,                   "_imul3 ",  ACLS_IMUL3, ASM_M0, "\151",                 XX,     P_186 )
...
CPDAT(  SEG,        000000|000000,      1,      1,      RNON,                   "_seg ",    ACLS_POP,   ASM_M0, "\46",                  XX,     P_86 )
...
*/
QDAT(   SCC,        000000|DUSECC|DZEROF,1,     2,      RNON,                   "_scc ",    ACLS_SCC,   ASM_M0, "\220",                 XX,     P_386 )
...
QDAT(   IMUL2,      000000|DSETCC|DZEROF,2,     2,      RNON,                   "_imul2 ",  ACLS_X2B,   ASM_M4, "\257",                 XX,     P_386 )
...
QDAT(   MOVSR,      XX,                 2,      XX,     XX,                     "_movsr ",  ACLS_MOVSR, ASM_M0, "\40",                  XX,     P_386 )
...
/*
** QC backend specific pseudo opcodes
*/
...
QPDAT(  PALIGN,     XX,                 XX,     XX,     XX,                     "_PALIGN ", ACLS_PSE2,  ASM_M6, NULL,               XX,     P_86 )
