...
typedef enum CV_call_e {
    ...
    CV_CALL_NEAR_ = 0x02, // near left to right push, callee pops stack
    CV_CALL_FAR_  = 0x03, // far left to right push, callee pops stack
