    ...
    )
{
    ...
    *phTMInfo = 0;
    ...
    pTMInfo = (struct TMI *)MHMemLock( *phTMInfo );
    ...
    *pvT = pExState->result;
    ...
    pExStr = (char*)MHMemLock(pExState->hExStr);
            ...
            case S_REGREL32:
                ...
                // Formal parameter
                    ...
                    if (checkThis && EVAL_IS_METHOD(pv) &&
                        ...
                        (_tcsncmp((const char *) ((LPREGREL32)pSym)->name+1, OpName[0].str+1, len) == 0)) {
                        checkThis = FALSE;
                        break;
                    }
                    checkThis = FALSE;
                    ...
                    if (((PROCPTRMIPS)pSym)->pParent) { // nested?
                        ...
                        if (hSLink32) {
                            ...
                            for (;;) {
                                ...
                                if (parent) {
                                    SYMPTR pParent = (SYMTYPE *)MHOmfLock(parent);
