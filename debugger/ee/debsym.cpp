                            ...
                            switch (pSym->rectyp) {
                                case S_BPREL32:
                                    ...
                                    // This is a formal argument
                                        ...
                                        if ((len == 12) &&
                                            (_tcsncmp((const char  *) ((BPRELPTR32)pSym)->name+1, "__$ReturnUdt", len) == 0)) {
                                            fAddSym = FALSE;
                                        }
                                    }
                                    break;
                                ...
                                case S_REGREL32:
                                    ...
                                    // Formal parameter
                                        ...
                                        if ((len == 12) &&
                                            (_tcsncmp((const char *) ((LPREGREL32)pSym)->name+1, "__$ReturnUdt", len) == 0)) {
                                            fAddSym = FALSE;
                                        }
                                    }
                                    break;
...
struct hreg_ia64 {
    char    name[10];  //v-vadimp we have "BSPSTORE"
    int     index;
    CV_typ_t   type;
} hreg_list_ia64[] = { 
    ...
    )
{
    ...
    NODE_OP (pn) = (op_t)OP_this;

    // change original node to OP_pointsto

    pn = (pnode_t)bn;
    memset (pn, 0, sizeof (node_t) + sizeof (eval_t));
    NODE_OP (pn) = (op_t)OP_pointsto;
