...
EMEXPORT HPRC WINAPI ValidHprcFromHpid ( HPID );
EMEXPORT HPID WINAPI HpidFromHprc ( HPRC );
EMEXPORT HTID WINAPI HtidFromHthd ( HTHD );
EMEXPORT HPRC WINAPI HprcFromHpid ( HPID );
EMEXPORT HPRC WINAPI HprcFromPid ( PID );
EMEXPORT HTHD WINAPI HthdFromHtid ( HPRC, HTID );
EMEXPORT HTHD WINAPI HthdFromTid ( HPRC, TID );
EMEXPORT HPID WINAPI HpidFromHthd(HTHD);
EMEXPORT XOSD WINAPI SendRequest ( DMF, HPID, HTID );
EMEXPORT XOSD WINAPI SendRequestX ( DMF dmf, HPID hpid, HTID htid, DWORD wLen, LPVOID lpv );

PID WINAPI PidFromHprc ( HPRC );
TID WINAPI TidFromHthd ( HTHD );
...
int EMENTRY WINAPI EXCComp(LPVOID, LPVOID, LONG);
...
void EMENTRY WINAPI PiDKill ( LPVOID );
void EMENTRY WINAPI TiDKill ( LPVOID );
void EMENTRY WINAPI MDIKill(LPVOID lpv);
int  EMENTRY WINAPI PDComp ( LPVOID, LPVOID, LONG );
int  EMENTRY WINAPI TDComp ( LPVOID, LPVOID, LONG );
int  EMENTRY WINAPI BPComp ( LPVOID, LPVOID, LONG );
int  EMENTRY WINAPI TBComp ( LPVOID, LPVOID, LONG );
int  EMENTRY WINAPI MDIComp ( LPVOID, LPVOID, LONG );
