...
typedef  XOSD   (WINAPI *PFNGETADDR) (HPID, HTID, ADR, LPADDR);
typedef  XOSD   (WINAPI *PFNSETADDR) (HPID, HTID, ADR, LPADDR);
typedef  LPVOID (WINAPI *PFNDOGETREG) (LPVOID, DWORD, LPVOID);
typedef  XOSD   (WINAPI *PFNGETREGVALUE) (HPID, HTID, DWORD, LPVOID);
typedef  LPVOID (WINAPI *PFNDOSETREG) (LPVOID, DWORD, LPVOID);
typedef  XOSD   (WINAPI *PFNSETREGVALUE) (HPID, HTID, DWORD, LPVOID);
typedef  XOSD   (WINAPI *PFNGETFLAG) (HPID, HTID, DWORD, LPVOID);
typedef  XOSD   (WINAPI *PFNSETFLAG) (HPID, HTID, DWORD, LPVOID);
typedef  XOSD   (WINAPI *PFNGETFRAME) (HPID, HTID, DWORD_PTR, DWORD_PTR);
typedef  XOSD   (WINAPI *PFNGETFRAMEEH) (HPID, HTID, LPEXHDLR *, LPDWORD);
typedef  XOSD   (WINAPI *PFNUPDATECHILD) (HPID, HTID, DMF);
typedef  VOID   (WINAPI *PFNADJUSTFORPROLOG) (HPID, HTID, PADDR, CANSTEP *);
typedef  VOID   (WINAPI *PFNCOPYFRAMEREGS) (LPTHD, LPBPR);
typedef  XOSD   (WINAPI *PFNGETFUNCTIONINFO) (HPID, LPGFI);
