...
// typedef XOSD (__stdcall *TLFUNC_ODP) ( TLF, HPID, DWORD64, DWORD64 );
// typedef XOSD (__stdcall*EMFUNC_ODP) ( EMF, HPID, HTID, DWORD64, DWORD64 );
// typedef XOSD (__stdcall*TLFUNCTYPE) ( TLF, HPID, DWORD64, DWORD64 );
// typedef XOSD (__stdcall*DMTLFUNCTYPE) ( TLF, HPID, DWORD64, DWORD64 );
// typedef XOSD (__stdcall*TLCALLBACKTYPE) (HPID, DWORD64, DWORD64 );
// typedef XOSD (__stdcall*LPDMINIT) ( DMTLFUNCTYPE, LPVOID );
// typedef VOID (__stdcall*LPDMFUNC) ( DWORD, LPBYTE );
// typedef DWORD (__stdcall*LPDMDLLINIT) ( LPDBF );
// typedef XOSD (__stdcall*LPUISERVERCB) (TLCB, HPID, HTID, DWORD64, DWORD64 );

typedef XOSD (__stdcall *TLFUNC_ODP) ( TLF, HPID, DWORD, DWORD );
typedef XOSD (__stdcall*EMFUNC_ODP) ( EMF, HPID, HTID, DWORD, DWORD );
typedef XOSD (__stdcall*TLFUNCTYPE) ( TLF, HPID, DWORD, DWORD );
typedef XOSD (__stdcall*DMTLFUNCTYPE) ( TLF, HPID, DWORD, DWORD );
typedef XOSD (__stdcall*TLCALLBACKTYPE) (HPID, DWORD, DWORD );
typedef XOSD (__stdcall*LPDMINIT) ( DMTLFUNCTYPE, LPVOID );
typedef VOID (__stdcall*LPDMFUNC) ( DWORD, LPBYTE );
typedef DWORD (__stdcall*LPDMDLLINIT) ( LPDBF );
typedef XOSD (__stdcall*LPUISERVERCB) ( TLCB, HPID, HTID, DWORD, DWORD );
...
void __stdcall ODPDKill  ( LPVOID );

void __stdcall EMKill    ( LPVOID );
int  __stdcall EMHpidCmp ( LPVOID, LPVOID, LONG );
void __stdcall EMPKill   ( LPVOID );

void __stdcall TLKill    ( LPVOID );

void __stdcall NullKill  ( LPVOID );
int  __stdcall NullComp  ( LPVOID, LPVOID, LONG );

typedef XOSD (__stdcall*FNCALLBACKDB) ( DBC, HPID, HTID, DWORD, DWORD, DWORD );
typedef XOSD (__stdcall*FNCALLBACKTL) ( TLF, HPID, DWORD, DWORD );
typedef XOSD (__stdcall*FNCALLBACKNT) ( EMF, HPID, HTID, DWORD, DWORD );
typedef XOSD (__stdcall*FNCALLBACKEM) ( EMF, HPID, HTID, DWORD, DWORD, DWORD );
