...
--*/
{
    ...
    llpid = LLInit (sizeof ( PROCESSINFO ), llfNull, (LPFNKILLNODE)ODPDKill, (LPFNFCMPNODE) NULL );
    lltl  = LLInit ( sizeof ( TLS ), llfNull, (LPFNKILLNODE)TLKill, (LPFNFCMPNODE) NULL );
    llem  = LLInit ( sizeof ( EMS ), llfNull, (LPFNKILLNODE)EMKill, (LPFNFCMPNODE) NULL );
...
--*/
{
    ...
    lpem->emtype = emtype;
    lpem->llhpid = LLInit ( sizeof ( HPID ), llfNull, NULL, (LPFNFCMPNODE)EMHpidCmp );
    if ( lpem->llhpid == 0 ) {
        xosd = xosdOutOfMemory;
    }

    xosd = (*lpem->emfunc) ( emfRegisterDBF, NULL, NULL, 0, (DWORD) lpdbf );
    CheckErr ( xosd );

    xosd = (*lpem->emfunc) ( emfInit,        NULL, NULL, 0, (DWORD)&emcb );
    CheckErr ( xosd );

    xosd = (*lpem->emfunc) ( emfGetModel,    NULL, NULL, 0, (DWORD)&dwModel );
    CheckErr ( xosd );
...
--*/
{
    ...
    assert ( hem != NULL );
    lpem = (LPEMS) LLLock ( (HLLE)hem );
    xosd = (lpem->emfunc) ( emfGetInfo, NULL, NULL, 0, (DWORD)lpemis );
    LLUnlock( (HLLE)hem );
    return xosd;
}
...
--*/
{
    ...
    assert ( hem != NULL );
    lpem = (LPEMS) LLLock ( (HLLE)hem );
    xosd = (lpem->emfunc) ( emfSetup, NULL, NULL, 0, (DWORD)lpemss );
    LLUnlock( (HLLE)hem );
    return xosd;
}
...
--*/
{
  ...
  *      initialization string ( lszTLData ).                               */
    ...
    if (htl) {
        ...
        switch(xosd = CallTL (tlfGetVersion, hpid, sizeof(Avs), (DWORD)&RemoteAvs)) {
            case xosdNone:
    ...
    if (xosd == xosdNone) {
        ...
        if (xosd == xosdNone) {
            xosd = lpem->emfunc (emfCreateHpid, hpid, NULL, 0, 0); // em!CreateHprc
        }
...
--*/
{
    ...
    if ( htid == NULL && adr != adrData ) {
        ...
        XOSD xosd = CallEM ( emfGetAddr, hpid, htid, adr, (DWORD)lpaddr );
...
--*/
{
    ...
    if ( htid == NULL && adr != adrData ) {
        ...
        return CallEM ( emfSetAddr, hpid, htid, adr, (DWORD)lpaddr );
    }
}
...
--*/
{
    ...
    xosd = CallEM( emfFixupAddr, hpid, htid, 0, (DWORD)&addrTmp );
...
{
    ADDR addrTmp = *lpaddr;
    XOSD xosd = CallEM( emfUnFixupAddr, hpid, htid, 0, (DWORD)&addrTmp );
...
--*/
{
    ...
    return CallEM( emfCompareAddrs, hpid, NULL, 0, (DWORD)&cas );
}
...
--*/
{
    ...
    remi.hemi   = hemi;
    remi.lsz    = lsz;
    return CallEM ( emfRegisterEmi, hpid, NULL, 0, (DWORD)&remi );
}
...
--*/
{
    return CallEM ( emfUnRegisterEmi, hpid, NULL, 0, (DWORD)hemi );
}
...
--*/
{
    return CallEM ( emfSetEmi, hpid, htid, 0, (DWORD)lpaddr );
}
...
--*/
{
    return CallEM( emfGetMemoryInfo, hpid, htid, sizeof(MEMINFO), (DWORD)lpMemInfo );
}
...
--*/
{
    ...
    xosd = CallEM ( emfSpawnOrphan, hpid, NULL, sizeof (sos), (DWORD)&sos );
...
--*/
{
    return CallEM( emfDebugActive, hpid, NULL, cbData, (DWORD)lpvPrivate);
}
...
--*/
{
    return CallEM( emfSetPath, hpid, 0, fSet, (DWORD)lszPath );
}
...
--*/
{
    return CallEM( emfGo, hpid, htid, 0, (DWORD)lpExop );
}
...
--*/
{
    return CallEM( emfSingleStep, hpid, htid, 0, (DWORD)lpExop );
}
...
--*/
{
    ...
    return CallEM( emfRangeStep, hpid, htid, 0 , (DWORD)&rss );
}
...
--*/
{
    return CallEM( emfReturnStep, hpid, htid, 0, (DWORD)lpExop );
}
...
{
    XOSD xosd;
    xosd = CallEM( emfSetupExecute, hpid, htid, 0, (DWORD)lphind);
...

{
    ...
    return CallEM( emfStartExecute, hpid, 0, (DWORD)hind, (DWORD)&es);
}                               /* OSDStartExecute() */
...
{
    return CallEM( emfCleanUpExecute, hpid, NULL, (DWORD)hind, 0);
}                               /* OSDCleanUpExecute() */
...
--*/
{
    return CallEM ( emfMetric, hpid, htid, mtrc, (DWORD)lpv );
}
...
--*/
{
    ...
    return CallEM( emfReadMemory, hpid, htid, 0, (DWORD)&rwms );
}
...
--*/
{
    ...
    return CallEM( emfWriteMemory, hpid, htid, 0, (DWORD)&rwms );
}
...
--*/
{
    ...
    return CallEM ( emfGetObjLength, hpid, htid, 0, (DWORD)&gol );
}
...
--*/
{
    ...
    return CallEM ( emfGetFunctionInfo, hpid, htid, 0, (DWORD)&gfi );
}
...
--*/
{
    return CallEM ( emfGetRegStruct, hpid, htid, iReg, (DWORD)lprd );
}
...
--*/
{
    return CallEM ( emfGetFlagStruct, hpid, htid, iFlag, (DWORD)lpfd );
}
...
--*/
{
    return CallEM ( emfGetReg, hpid, htid, dwIndex, (DWORD)lpv );
}
...
--*/
{
    return CallEM ( emfSetReg, hpid, htid, dwIndex, (DWORD)lpv );
}
...
{
    assert ( lpv != NULL );
    return CallEM ( emfGetFlag, hpid, htid, dwIndex, (DWORD)lpv );
}
...
--*/
{
    return CallEM ( emfSetFlag, hpid, htid, dwIndex, (DWORD)lpv );
}
...
--*/
{
    return CallEM ( emfSaveRegs, hpid, htid, 0, (DWORD)lphmem );
}
...
--*/
{
    return CallEM ( emfRestoreRegs, hpid, htid, 0, (DWORD)hmem );
}
...
{
    assert ( lpsdi != NULL );
    return CallEM ( emfUnassemble, hpid, htid, 0, (DWORD)lpsdi );
}
...
--*/
{
    ...
    return CallEM ( emfAssemble, hpid, htid, (DWORD)lpaddr, (DWORD)lsz );
}
    ...
    )
{
    ...
    while ( !fFound && GetAddrOff ( addr ) < GetAddrOff ( *lpaddr ) ) {
        ...
        CallEM ( emfUnassemble, hpid, htid, sizeof( sdi ), (DWORD)&sdi );
...
--*/
{
    return CallEM ( emfGetFrame, hpid, htid, cFrame, (DWORD)lphtid );
}
...
--*/
{
    return CallEM( emfThreadStatus, hpid, htid, 0, (DWORD)lptst );
}
...
--*/
{
    return CallEM( emfProcessStatus, hpid, NULL, 0, (DWORD)lppst );
}
...
--*/
{
    if (hpid == 0) {
        ...
        // a pointer to an EMFunc.    SEPtrTo64
        //
        return ((XOSD (OSDAPI *)(EMF, HPID, HTID, DWORD, DWORD))htid) (
                emfGetExceptionState, 0, 0, 0, (DWORD)(lpExd) );
    } else {
        return CallEM ( emfGetExceptionState, hpid, htid, 0, (DWORD)lpExd );
    }
}
...
--*/
{
    return CallEM( emfSetExceptionState, hpid, htid, 0, (DWORD)lpExd );
}
...
--*/
{
    return CallEM ( emfGetMessageMap, hpid, htid, 0, (DWORD)lplpMessageMap );
}
...
--*/
{
    return CallEM ( emfGetMessageMaskMap, hpid, htid, 0, (DWORD)lplpMaskMap );
}
...
--*/
{
    return CallEM( emfInfoReply, hpid, htid, cbData, (DWORD)lpvData );
}
...
--*/
{
    return CallEM ( emfGetTaskList, hpid, NULL, 0, (DWORD)lplpTaskList );
}
...
--*/
{
    ...
    sdms.cbData = cbData;
    return CallEM( emfSetDebugMode, hpid, NULL, 0, (DWORD)&sdms );
}
...
--*/
{
    ...
    xosd = (lpemp->emfunc) ( emf, hpid, htid, cb, (DWORD) lpv );
...
--*/
{
    ...
    xosd = (*emfunc)( emfDebugPacket, hpid, NULL, cb, (DWORD)lpv );
...
--*/
{
    ...
    if (lpemp->emfunc != NULL) {
       xosd = (lpemp->emfunc)( emf, hpid, htid, wValue, (DWORD) lpv );
    } else {
       xosd = xosdInvalidParameter;
    }
    LLUnlock ( (HLLE)hemp );
...
--*/
{
    ...
    if (!htl) {
        ...
        lptl = (LPTL) LLLock ( (HLLE)htl );
        xosd = lptl->tlfunc ( tlf, hpid, wValue, (DWORD)lpv );
        LLUnlock ( (HLLE)htl );
    }
...
--*/
{
    ...
    while ( xosd == xosdPunt ) {
        ...
        xosd = (lpemp->emfunc) ( emfDbc, hpid, htid, sizeof(DBCPK), (DWORD)&dbcpk );
        LLUnlock ( (HLLE)hemp );
    }
    return xosd;
}
...
--*/
{
    ...
    xosd = lptl->tlfunc (tlfGetLastError, hpid, Length, (DWORD)Buffer);
    ...
    )
{
    ...
    xosd = CallEM (emfGetTimeStamp, hpid, htid, sizeof (tcs), (DWORD)&tcs);
    ...
    )
{
    ...
    lppid->llemp = LLInit ( sizeof ( EMP ), llfNull, (LPFNKILLNODE)EMPKill, NULL );
