...
ResendPacket:
    ...
    rc = DmKdWriteComPort((PUCHAR)PacketData, PacketDataLength, &BytesWritten);
...
DbgkdGetVersion32To64(
	PDBGKD_GET_VERSION32 pGetVersion32,
	PDBGKD_GET_VERSION64 pGetVersion64,
...
WaitStateChange32To64(
	PDBGKD_WAIT_STATE_CHANGE32 LocalStateChange, 
...
DbgkdManipulateState32To64(
	PDBGKD_MANIPULATE_STATE32 pDmKdPacket, 
	PDBGKD_MANIPULATE_STATE64 pPacket64,
	PDWORD pAdditionalDataSize
	)
{
	__asm int 3;
	return FALSE;
