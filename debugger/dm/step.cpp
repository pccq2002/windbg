...

{
	...
	hthd->tstate = (TSTATEX)((DWORD)hthd->tstate | ts_stepping);
#endif
...
--*/
{
    ...
    AddrReadMemory(hthd->hprc, hthd, &Addr, Memory, RangeSize, (PULONG)&Length );
#ifndef KERNEL
    ...
    )
{
    ...
    if (rs->fIsCall) {
        ...
        //
        wt = (LPWTNODE)MHAlloc( sizeof(WTNODE) );
