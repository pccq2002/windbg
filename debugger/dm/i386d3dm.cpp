...
void OutputHexString (LPLPCH lplpchBuf,int * UnKnown,  PCH pchValue, int length)
{
    unsigned char    chMem;
...
XOSD Disassemble( HPID, HTID, LPSDI, PVOID, INT, BOOL )
{
	return (XOSD)0;
}
...
)
{
	...
	OutputHexString ( ppBuf, pcch, (LPCH) &( *lpaddrOp ), 4 );
}
