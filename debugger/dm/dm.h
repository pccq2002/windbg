...
typedef struct _PUSERMODE_CRASHDUMP_HEADER
{
	DWORD MajorVersion;
	DWORD MinorVersion;
	DWORD ModuleCount;
	DWORD ThreadCount;
	PUCHAR DebugEventOffset;
...
INT FAR __stdcall NLGComp  ( LPNLG, LPVOID, LONG );
VOID
ActionNLGDispatch(
    DEBUG_EVENT64* de,
    HTHDX hthd,
...
DmpReadControlSpace(
					IN USHORT Processor,
					IN DWORD64 TargetBaseAddress,
					OUT PVOID UserInterfaceBuffer,
					IN ULONG   TransferCount,
					IN PULONG  ActualBytesRead
            );
