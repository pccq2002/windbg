...

{
    ...
    if ( hprc ) {
        ...
        if ( hthd ) {
            ...
            if (Walk) {
                GroupList = (PLIST_ENTRY)MHAlloc(sizeof(LIST_ENTRY));
...
--*/
{
    ...
    while (OldList != &OldWalk->GroupEntryList) {
        ...
        NewEntry = (PWALK_GROUP_ENTRY)MHAlloc(sizeof(WALK_GROUP_ENTRY));
...
--*/
{
    ...
    Entry = (PWALK_GROUP_ENTRY)MHAlloc(sizeof(WALK_GROUP_ENTRY));
